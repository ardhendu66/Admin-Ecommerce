            ...
            try {
                ...
                if(res.status === 200) {
                    ...
                    setProperties((prev: any) => {
                        if(
                            typeof res.data.properties !== "undefined" && res.data.properties !== null
                        ) {
    ...
    if(cname && sname && id) {
        return (
            <Layout>
                ...
                <form 
                    className="mt-3"
                    onSubmit={(e: React.FormEvent<HTMLFormElement>) => updateSubCategory(e)}
                >
                    ...
                    Object.entries(properties)?.map(([key, value]: any, index) => (
                        ...
                        >
                            <input 
                                ...
                                onChange={e => handlePropertyNameChange(e.target.value, key)}
                            />
                            <input 
                                type="text"
                                value={value}
